import { makePlaceholder } from '../makeValue'
...
export function descToItem(...args: unknown[]): Item {
	return remoteCall('descToItem', args, makePlaceholder('Item', 'none') as Item)
}
...
export function eudoraItem(...args: unknown[]): Item {
	return remoteCall('eudoraItem', args, makePlaceholder('Item', 'none') as Item)
}
...
export function useRPrompt(message: string, options: unknown): string
...
export function weaponType(...args: unknown[]): Stat {
	return remoteCall('weaponType', args, makePlaceholder('Stat', 'none') as Stat)
}
